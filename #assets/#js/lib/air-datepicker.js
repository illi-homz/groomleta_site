!(function (e, t) {
	...
	return (function () {
		...
		class _ {
			...
			init() {
				var {range: e, onRenderCell: t} = this.opts;
				t &&
					(this.customData = t({
						date: this.date,
			...
			_createElement() {
				var {year: e, month: t, date: i} = o(this.date);
				this.$cell = n({
			...
			_getHtml() {
				var e;
				var {year: t, month: s, date: a} = o(this.date),
			...
			_isOutOfMinMaxRange() {
				var {minDate: e, maxDate: t} = this.dp,
					{type: s, date: a} = this,
			...
			_handleRangeStatus() {
				var {rangeDateFrom: e, rangeDateTo: t} = this.dp,
					i = c({
						'-in-range-':
							e &&
							t &&
		...
		class S {
			constructor(e) {
				...
				M(this, 'handleClick', e => {
					...
					s
						? this.dp._handleAlreadySelectedDates(s, i.date)
			...
			_bindEvents() {
				var {range: e, dynamicRange: t} = this.opts;
			...
			_generateMonthCells() {
				var {year: e} = this.dp.parsedViewDate,
					t = 0;
		...
		class F {
			constructor(e) {
				...
				T(this, 'onClickNav', e => {
					...
					T(this, 'update', () => {
						var {prevHtml: e, nextHtml: t} = this.opts;
			...
			handleNavStatus() {
				var {disableNavWhenOutOfRange: e} = this.opts,
					{minDate: t, maxDate: s} = this.dp;
				if ((!t && !s) || !e) return;
				var {year: a, month: n} = this.dp.parsedViewDate,
					r = !!t && o(t),
					h = !!s && o(s);
				...
				switch (this.dp.currentView) {
					...
					case i.years: {
						...
						t && r.year >= _e7[0] && this._disableNav('prev'),
							s && h.year <= _e7[1] && this._disableNav('next');
						break;
					}
				}
			}
		...
		class L {
			constructor() {
				...
				x(this, 'toggleTimepickerIsActive', e => {
					...
					(this.opts = e),
					(this.dp = t);
				var {timeFormat: s} = this.dp.locale;
			...
			setMinMaxTime(e) {
				if ((this.setMinMaxTimeFromOptions(), e)) {
					var {minDate: _t6, maxDate: _i6} = this.dp;
					_t6 && u(e, _t6) && this.setMinTimeFromMinDate(_t6),
						_i6 && u(e, _i6) && this.setMaxTimeFromMaxDate(_i6);
				}
			}

			setCurrentTime(e) {
				var {hours: t, minutes: i} = e ? o(e) : this;
			...
			setMinTimeFromMinDate(e) {
				var {lastSelectedDate: t} = this.dp;
			...
			set hours(e) {
				this._hours = e;
				var {hours: t, dayPeriod: i} = this.getDayPeriod(e);
					...
					O(this, 'onKeyDown', e => {
						...
						if ('Enter' === t) {
							...
							if (a) {
								...
								return void (_e8
									? s._handleAlreadySelectedDates(_e8, a)
									: s.selectDate(a));
							}
						}
		...
		class K {
			constructor(e, t) {
				var r = this;
				if (
					(N(this, 'viewIndexes', [i.days, i.months, i.years]),
					N(this, 'next', () => {
						var {year: e, month: t} = this.parsedViewDate;
					...
					N(this, '_getInputValue', e => {
						var {selectedDates: t, opts: i} = this,
					...
					N(this, 'setViewDate', e => {
						...
						var t = this.viewDate;
						this.viewDate = e;
						var {onChangeViewDate: s} = this.opts;

						if (s) {
							var {month: _e10, year: _t7} = this.parsedViewDate;
							s({
								month: _e10,
								year: _t7,
					...
					N(this, 'destroy', () => {
						var {showEvent: e, isMobile: t} = this.opts,
					...
					N(this, 'isWeekend', e => this.opts.weekends.includes(e)),
					N(this, 'getClampedDate', e => {
						var {minDate: t, maxDate: i} = this,
							s = e;
						return (
				...
				(this.$datepicker = n({
					...
					I || (I = a('body'));
				var {view: h, startDate: l} = this.opts;
			...
			init() {
				...
				B ||
					...
					I.appendChild(R)),
					!s || P || t || this._createMobileOverlay(),
					this._handleLocale(),
					this._bindSubEvents(),
					this._createMinMaxDates(),
					this._limitViewDateByMaxMinDates(),
			...
			_createComponents() {
				...
				this._buildBaseHtml(),
					...
					(this.views[this.currentView] = new S({
						dp: this,
			...
			_createMinMaxDates() {
				var {minDate: e, maxDate: t} = this.opts;
			...
			_limitViewDateByMaxMinDates() {
				var {viewDate: e, minDate: t, maxDate: i} = this;
			...
			show() {
				var {onShow: e, isMobile: t} = this.opts;
				this._cancelScheduledCall(),
					this.visible ||
						this.hideAnimation ||
			...
			hide() {
				var {onHide: e, isMobile: t} = this.opts,
			...
			_handleAlreadySelectedDates(e, t) {
				var {range: i, toggleSelected: s} = this.opts;
				i
					? s
						? this.unselectDate(t)
		...
		return (
			N(K, 'defaults', s),
			N(K, 'version', '3.1.0'),
			N(K, 'defaultContainerId', 'air-datepicker-global-container'),
			(j = K.prototype),
			Object.assign(j, A),
			t.default
		);
