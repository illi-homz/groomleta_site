...
!function (e, t) {
  ...
  return function () {
    ...
    function r(e, t) {
      for (var [_i2, _s] of Object.entries(t)) {
      ...
      return i.filter(e => e).forEach(t => {
        for (var [_i4, _s2] of Object.entries(t)) {
          if (void 0 !== _s2 && "[object Object]" === _s2.toString()) {
            ...
            e[_i4] = e[_i4] ? _t3 !== _a ? _n : e[_i4] : _n, w(e[_i4], _s2);
          } else e[_i4] = _s2;
        }
      }), e;
    }
    ...
    class S {
        ...
        M(this, "handleClick", e => {
          ...
          if (2 === s.length) {
            if (this.rangeFromFocused && !p(r, a)) {
              ...
              r.setHours(_e3), r.setMinutes(_t4), this.dp.rangeDateFrom = r, this.dp.replaceDate(n, r);
            }
      ...
      _getDaysCells() {
        ...
        for (; D < u;) {
          var _e6 = new Date(m, g, p + D);

          this._generateCell(_e6), D++;
        }
      }
    ...
    class L {
      ...
      setMinMaxTime(e) {
        if (this.setMinMaxTimeFromOptions(), e) {
          ...
          _t6 && u(e, _t6) && this.setMinTimeFromMinDate(_t6), _i6 && u(e, _i6) && this.setMaxTimeFromMaxDate(_i6);
        }
      }
        ...
        O(this, "pressedKeys", new Set()), O(this, "hotKeys", new Map([[[["Control", "ArrowRight"], ["Control", "ArrowUp"]], e => e.month++], [[["Control", "ArrowLeft"], ["Control", "ArrowDown"]], e => e.month--], [[["Shift", "ArrowRight"], ["Shift", "ArrowUp"]], e => e.year++], [[["Shift", "ArrowLeft"], ["Shift", "ArrowDown"]], e => e.year--], [[["Alt", "ArrowRight"], ["Alt", "ArrowUp"]], e => e.year += 10], [[["Alt", "ArrowLeft"], ["Alt", "ArrowDown"]], e => e.year -= 10], [["Control", "Shift", "ArrowUp"], (e, t) => t.up()]])), O(this, "handleHotKey", e => {
          ...
          var {
            ...
            date: n
              ...
              r = h(new Date(s, a));
          r < n && (n = r);
          var l = this.dp.getClampedDate(new Date(s, a, n));
    ...
    class K {
        ...
        if (N(this, "viewIndexes", [i.days, i.months, i.years]), N(this, "next", () => {
          ...
          if (this.viewIndexes.includes(e)) {
            if (this.currentView = e, this.elIsInput && this.visible && this.setPosition(void 0, !0), this.trigger(i.eventChangeCurrentView, e), !this.views[e]) {
              ...
              this.$content.appendChild(_t8.$el);
            }
      ...
      formatDate() {
        ...
        for (var [_e13, _t9] of Object.entries(l)) {
          i = r(i, k(_e13), _t9);
        }
      ...
      replaceDate(e, t) {
        var s = this.selectedDates.find(t => u(t, e, this.currentView)),
...
grummer.popup = {
  ...
  open(popup, noClickEvent) {
    ...
    typeof popup === 'string' ? $popup = $(".".concat(popup)).addClass('open') : $popup = popup.addClass('open');
  ...
  close(popup) {
    ...
    if (this.unlock) {
      typeof popup === 'string' ? $(".".concat(popup)).removeClass('open') : popup.removeClass('open');
  ...
  bodyLock() {
    var lockPaddingValue = window.innerWidth - this.body.innerWidth() + 'px';
    this.body.css({
...
grummer.services = {
  ...
  initSlider() {
    ...
    $('._services__slider').slick(_objectSpread(_objectSpread({}, options), {}, {
      infinite: true,
  ...
  filter(_ref) {
    ...
    $('._services__slider').slick('slickFilter', (_, slide) => {
      if (animal && category) {
        return $(slide).find("._services__slide.category-".concat(category, ".").concat(animal, ",._services__slide.any")).length;
      }

      if (animal && breed) {
        var _$$find$attr;

        var slideBreed = (_$$find$attr = $(slide).find('._services__slide').attr('breed')) === null || _$$find$attr === void 0 ? void 0 : _$$find$attr.toLowerCase();
        var isBreed = breed.toLowerCase().includes(slideBreed === null || slideBreed === void 0 ? void 0 : slideBreed.trim());
        var isAnimal = $(slide).find("._services__slide.".concat(animal, ",._services__slide.any")).length;
        return isBreed && isAnimal;
      }

      if (animal) {
        return $(slide).find("._services__slide.".concat(animal, ",._services__slide.any")).length;
      }

      if (category) {
        return $(slide).find("._services__slide.category-".concat(category)).length;
      }

      if (breed) {
        var _$$find$attr2;

        var _slideBreed = (_$$find$attr2 = $(slide).find('._services__slide').attr('breed')) === null || _$$find$attr2 === void 0 ? void 0 : _$$find$attr2.toLowerCase();

        return breed.toLowerCase().includes(_slideBreed === null || _slideBreed === void 0 ? void 0 : _slideBreed.trim());
      }
...
grummer.ourworks = {
  ...
  moveArrows(isInit) {
    ...
    setTimeout(() => {
      var CurrentSlide = $(".ourworks .slick-current.slick-center").get(0);
...
grummer.questions = {
  ...
  toggleText(el) {
    var $el = $(el);
    var $parent = $el.parent('.questions__item');
    var $text = $el.siblings('.questions__item-text');
...
grummer.callback = {
  ...
  submit(form, event) {
    return _asyncToGenerator(function* () {
      ...
      var res = yield grummer.tlg.sendCallback(msg, csrf);
...
grummer.popupFeedback = {
  ...
  submit(form, event) {
    return _asyncToGenerator(function* () {
      ...
      var res = yield grummer.tlg.sendFeedback(msg, csrf);
  ...
  changeCounter(fieldInput) {
    var textLength = fieldInput.value.length;
...
grummer.popupOk = {
  ...
  setTimeInterval() {
    ...
    var timeStr = num => "".concat(num, " \u0441\u0435\u043A");

    $('._popup-ok__timer-time').text(timeStr(time));
    var interval = setInterval(() => {
      $('._popup-ok__timer-time').text("".concat(--time, " \u0441\u0435\u043A"));
...
grummer.popupMain = {
  ...
  init() {
    new AirDatepicker('#datepicker', {
      ...
      position(_ref3) {
        ...
        var top = coords.y + coords.height + window.scrollY + 4;
        var left = coords.x;
        $datepicker.style.left = "".concat(left, "px");
        $datepicker.style.top = "".concat(top, "px");
        $datepicker.style.width = "".concat(coords.width, "px");
  ...
  open() {
    ...
    var html = this.createServicesListHtml();
  ...
  renderImage(img, idx) {
    ...
    var $imageWrapper = $('<div></div>').addClass('popup-main__form-image-wrapper').addClass('_popup-main__form-image-wrapper').attr('id', 'image-' + idx);
    var $imageRemove = $('<div></div>').addClass('popup-main__form-image-remove');
...
grummer.popupServices = {
  ...
  initSlider() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    $('.popup-services__slider-services').slick(_objectSpread(_objectSpread({}, options), {}, {
      infinite: true,
      prevArrow: "<div class=\"prev-arrow slider-arrow\">".concat(arrow, "</div>"),
      // from fragments
      nextArrow: "<div class=\"next-arrow slider-arrow\">".concat(arrow, "</div>")
      ...
      var options = this.getSliderOptions();
      $('.popup-services__slider-services').slick('slickSetOption', options);
    });
  },
